          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-6">
              <a
                ...
                className="inline-flex items-center justify-center gap-3 px-5 py-3 rounded-xl border border-[#2A2A2A] bg-[#1A1A1A]/30 text-white hover:text-white hover:border-pink-500/50 hover:bg-gradient-to-r hover:from-purple-600/20 hover:to-pink-600/20 transition-all duration-300 hover:scale-[1.03] active:scale-95 shadow-md hover:shadow-[0_0_20px_rgba(219,39,119,0.15)] group font-body text-sm font-semibold"
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5 text-[#6B6B6B] group-hover:text-pink-500 transition-colors duration-300" fill="currentColor">
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="WhatsApp"
                className="inline-flex items-center justify-center gap-3 px-5 py-3 rounded-xl border border-[#2A2A2A] bg-[#1A1A1A]/30 text-white hover:text-white hover:border-[#25D366]/50 hover:bg-[#25D366]/10 transition-all duration-300 hover:scale-[1.03] active:scale-95 shadow-md hover:shadow-[0_0_20px_rgba(37,211,102,0.15)] group font-body text-sm font-semibold"
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5 text-[#6B6B6B] group-hover:text-[#25D366] transition-colors duration-300" fill="currentColor">
