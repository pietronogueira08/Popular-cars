...
const INSTAGRAM_URL = "https://www.instagram.com/popular_veiculos_/";
          ...
          <div className="flex items-center justify-between h-20 md:h-24">
            ...
            <div className="hidden md:flex items-center gap-3">
              <a
                ...
                className="inline-flex items-center gap-2 border border-[#FFD700]/40 text-[#FFD700] font-heading font-bold text-sm px-4 py-2.5 rounded-full transition-all hover:bg-[#FFD700]/10 hover:scale-105 min-h-[44px]"
              >
                {IG_ICON}
                Instagram
              </a>
            ...
            >
              ...
              <div className="px-4 pb-8 pt-4 border-t border-[#2A2A2A] space-y-3">
                <a
                  ...
                  className="flex items-center justify-center gap-2 border border-[#FFD700]/40 text-[#FFD700] font-heading font-bold text-sm px-5 py-3 rounded-full w-full transition-all hover:bg-[#FFD700]/10 active:scale-95"
                  onClick={() => setMobileOpen(false)}
                >
                  {IG_ICON}
                  Instagram
